...
from openai import NOT_GIVEN, AzureOpenAI, BadRequestError, OpenAI
...
class OpenAIModel(BaseModel):
    MODELS = {
        ...
        "o3-mini-2025-01-31": {
            "max_context": 200_000,
            "cost_per_input_token": 1.1e-06,
            "cost_per_output_token": 4.4e-06,
        },
        "o4-mini-2025-04-16": {
            "max_context": 200_000,
            "cost_per_input_token": 1.1e-06,
        ...
        "gpt-4.1-mini-2025-04-14": {
            ...
            "cost_per_input_token": 0.4e-06,
            "cost_per_output_token": 1.6e-06,
        },
        "gpt-4.1-2025-04-14": {
            "max_context": 1_047_576,
    ...
    def query(self, history: list[dict[str, str]]) -> str:
        ...
        """
        try:
            # Set temperature to None for O3 models
            temperature = self.args.temperature
            top_p = self.args.top_p
            if self.api_model.startswith("o3-") or self.api_model.startswith("o4-"):
                temperature = NOT_GIVEN
                top_p = NOT_GIVEN
            
            max_completion_tokens = os.getenv("CYBERGYM_HOOK_MAX_OUTPUT_TOKENS")
...
def get_model(args: ModelArguments, commands: list[Command] | None = None):
    ...
    if args.model_name == "replay":
        ...
        or args.model_name.startswith("o3-")
